...
class DeepSpeechFragment : Fragment() {

    private var _binding: FragmentDeepSpeechBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDeepSpeechBinding.inflate(inflater, container, false)
        return binding.root
    }
